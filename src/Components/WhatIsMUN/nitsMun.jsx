    ...
    return(
        ...
        <div className="img1">
            <div className="wing">
              <div className="text">
              <h1>700+</h1>
              <p>Delegates hosted till date</p>
              </div>
            </div>
            <div className="wing">
             <div className="text">
