    ...
    return (
        <div className={styles.Herotimeline}>
            ...
            <div className={styles.container}>
                <div className={styles.timeStamp} style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', columnGap: '2rem' }}>
    ...
    return (
        <div className={styles.Herocard}>
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-around' }} className={styles.Herodetails}>
                <img src='https://res.cloudinary.com/dhry5xscm/image/upload/v1695657514/nitsmun/MUN_RTU_LOGO_2_ugychb.svg' className={styles.Herologo} />
                <h1 style={{ color: '#ffffff', borderBottom: '1px solid #ffffff', textAlign: 'center' }} className={styles.Heroorg}>NITSMUN</h1>
