    ...
    return (
        <div className={styles.about}>
            ...
            <div className={styles.paraCont}>
                ...
                <p className={styles.para}>
                    UNSC (United Nations Security Council), with the agenda “The Occupation of major water ways for strong military presence overseas and it&pos;s impact on overseas trade.”
                </p>
                <p className={styles.para}>
...
const Glimpses = () => {
    return (
        <div className={styles.glimpses}>
            <div className={styles.headerCont}><h1 className={styles.h1}>Some Glimpses of NITSMUN 2023</h1></div>
            <div className={styles.innerCont}>
                <img className={styles.photoCont} alt="loading..." src="https://res.cloudinary.com/dhry5xscm/image/upload/v1705864080/nitsmun/foot_bg_qgtjeq.svg" />
            </div>
        </div>
    );
}
                ...
                <div className={styles.mainHeading}>
                    ...
                    <div className={styles.innerCont}>
                        <div className={styles.imgParent}>
                            <img src="https://res.cloudinary.com/dhry5xscm/image/upload/v1705864086/nitsmun/committee_yehz0a.svg" alt="loading..." className={styles.img} />
                        </div>
                        <div className={styles.content}>
                            <h1 className={styles.h1}>United Nations Security Council</h1>
                            <p className={styles.p}>
                                <p className={styles.innerPara}>
                                    <b>Agenda:</b> Addressing State-Sponsored terrorism: examining allegations and promoting regional stability in Asia with special emphasis on Afghanistan, Pakistan and Syria.
                                </p>
                                <p className={styles.innerPara}>
