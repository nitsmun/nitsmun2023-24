...
const Home = () => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <Letter name="Maruf Padaya" alt="Maruf Padaya" src="https://res-console.cloudinary.com/duom8ur6p/thumbnails/transform/v1/image/upload/Yl9hdXRvOnByZWRvbWluYW50LGNfcGFkLGhfMzAwLHdfMzAwLGZfanBnLGZsX2xvc3N5LmFueV9mb3JtYXQucHJlc2VydmVfdHJhbnNwYXJlbmN5LnByb2dyZXNzaXZl/v1/bml0c211bi9tZDdmMDVkaTF6eWRqY3Fsa3RhaQ==/template_primary" title="Letter from Secretary General" Name="Maruf Padaya" letter="secretary general" />
      <Nitsmun />
      <Reviews />
    </div>
  );
